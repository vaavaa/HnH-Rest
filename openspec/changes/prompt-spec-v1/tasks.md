...
- [x] Create feature branch: feature/prompt-spec-v1
- [x] Commit OpenSpec artifacts before implementation
- [x] Commit each phase separately
- [x] Do not modify spec after implementation begins (unless new change)
- [x] All commits must reference change-id: prompt-spec-v1
